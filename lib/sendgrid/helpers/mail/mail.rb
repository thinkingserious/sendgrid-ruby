...
module SendGrid
  class Mail
    ...
    attr_reader :personalizations, :contents, :attachments, :categories, :sections, :headers,
                :custom_args
    ...
    def to_json(*)
      {
        ...
        'attachments' => self.attachments.empty? ? nil : self.attachments,
        'template_id' => self.template_id,
        'sections' => self.sections.empty? ? nil : self.sections,
        'headers' => self.headers.empty? ? nil : self.headers,
        'categories' => self.categories.empty? ? nil : self.categories,
        'custom_args' => self.custom_args.empty? ? nil : self.custom_args,
